    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="mx-auto max-w-7xl px-6 py-10">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between animate-in">
          <div className="inline-flex rounded-full bg-surface p-1 ring-1 ring-border">
            {(
              ...
              <button
                key={id}
                onClick={() => setTab(id)}
                className={`rounded-full px-4 py-2 text-xs font-bold uppercase tracking-widest transition-all duration-150 ${
                  tab === id
          ...
          <div className="flex items-center gap-2 rounded-full border border-border bg-surface px-4 py-2 ring-1 ring-border transition-all duration-150 focus-within:border-brand/50">
        ...
        {filtered.length === 0 ? (
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {filtered.map((m, i) => (
              <div
                key={m.id}
                className="group flex flex-col overflow-hidden rounded-2xl border border-border bg-surface transition-all duration-200 hover:border-brand/40 hover:glow-sm animate-in"
              ...
              >
                ...
                <div className="flex flex-1 flex-col p-5">
                  ...
                  <div className="mt-5 flex items-center justify-between">
                    ...
                    <button
                      onClick={m.onAdd}
                      className="inline-flex items-center gap-1.5 rounded-full bg-brand px-4 py-2.5 text-xs font-black uppercase tracking-widest text-brand-foreground transition-all duration-150 hover:glow-sm"
                    >
