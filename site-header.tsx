      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 md:px-6">
        <div className="flex items-center gap-8">
          <Link to="/" className="group flex items-center gap-2">
            <div className="grid size-8 place-items-center rounded-lg bg-brand text-brand-foreground transition-all duration-150 group-hover:glow-sm">
        ...
        <div className="flex items-center gap-2 md:gap-3">
          <div className="hidden flex-col items-end leading-tight sm:flex">
            ...
            <span className="text-sm font-black text-brand transition-all duration-150 hover:glow-sm">
              {credits.toFixed(1)}
            </span>
          </div>
          <Link
            to="/order"
            className="group hidden items-center gap-2 rounded-full bg-brand px-4 py-2 text-xs font-black uppercase tracking-widest text-brand-foreground transition-all duration-150 hover:glow lg:inline-flex"
          >
            Commander
          ...
          <Link
            to="/cart"
            className="group relative flex items-center gap-2 rounded-full bg-surface px-3 py-2 text-sm font-semibold ring-1 ring-border transition-all duration-150 hover:bg-surface-2 hover:ring-brand/30"
          >
            <ShoppingBag className="size-4 transition-transform group-hover:scale-110" />
            <span className="hidden sm:inline">Panier</span>
            {t.items > 0 && (
              <span className="grid size-5 place-items-center rounded-full bg-brand text-[10px] font-black text-brand-foreground transition-all duration-150 animate-in">
                {t.items}
              </span>
            )}
          </Link>
