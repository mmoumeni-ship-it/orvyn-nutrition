  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="mx-auto max-w-7xl px-6 py-10">
        <div className="mt-8 flex items-center gap-3 rounded-full border border-border bg-surface px-5 py-3 ring-1 ring-border transition-all duration-150 focus-within:border-brand/50 animate-in">
            ...
            {list.map((g, i) => {
              ...
              return (
                <button
                  ...
                  className={`group rounded-2xl border bg-surface p-6 text-left transition-all duration-150 animate-in ${
                    selected
