      ...
      <div className="mx-auto max-w-7xl px-6 py-12">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          {SUBS.map((s, i) => (
            <div
              key={s.id}
              className={`relative flex flex-col rounded-3xl border p-8 animate-in transition-all duration-500 hover:glow-sm ${
                s.popular
            ...
            >
              ...
              <button
                ...
                className={`mt-8 inline-flex items-center justify-center gap-2 rounded-xl py-4 text-sm font-black uppercase tracking-widest transition-all duration-300 ${
                  s.popular
        ...
        <div className="mt-16 animate-in rounded-3xl border border-border bg-surface p-8 transition-all duration-300 hover:glow-sm">
          ...
          <Link
            to="/order"
            className="group mt-8 inline-flex items-center gap-2 rounded-full bg-brand px-6 py-3 text-xs font-black uppercase tracking-widest text-brand-foreground transition-all duration-300 hover:glow"
          >
