    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="mx-auto max-w-7xl px-6 py-12">
        <div className="flex flex-wrap items-end justify-between gap-6 animate-in">
          ...
          <Link
            to="/order"
            className="group inline-flex items-center gap-2 rounded-full bg-brand px-5 py-3 text-xs font-black uppercase tracking-wider text-brand-foreground transition-all duration-300 hover:glow"
          >
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-3 animate-in animate-in-delay-2">
          <div className="rounded-2xl border border-border bg-surface p-6 lg:col-span-2 transition-all duration-300 hover:glow-sm">
            ...
            <div className="mt-5 space-y-3">
              {[
                ...
                <div
                  key={o.d}
                  className="flex items-center justify-between rounded-xl bg-background p-4 transition-all duration-300 hover:bg-surface-2"
          ...
          <div className="rounded-2xl border border-brand/40 bg-gradient-to-br from-brand/10 via-brand/5 to-surface p-6 transition-all duration-300 hover:glow-sm">
            ...
            <Link
              to="/order"
              className="group mt-5 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-brand py-3 text-xs font-black uppercase tracking-wider text-brand-foreground transition-all duration-300 hover:glow"
            >
        ...
        <div className="mt-10 animate-in animate-in-delay-3">
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-3">
            {favs.map((m, i) => (
              <div
                key={m.id}
                className="group rounded-2xl border border-border bg-surface p-5 transition-all duration-300 hover:border-brand/40 hover:glow-sm"
                style={{ animationDelay: `${i * 0.1}s` }}
              >
        ...
        <div className="mt-10 animate-in animate-in-delay-4">
          <Link
            to="/order"
            className="group flex items-center gap-3 rounded-2xl border border-border bg-surface p-5 transition-all duration-300 hover:border-brand/40 hover:glow-sm"
          >
...
function Stat({
  ...
  return (
    <div className="rounded-2xl border border-border bg-surface p-5 transition-all duration-300 hover:border-brand/40 hover:glow-sm">
      <div className="flex items-center justify-between">
