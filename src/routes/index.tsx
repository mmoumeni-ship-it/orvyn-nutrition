        ...
        <div className="mx-auto flex min-h-[calc(100svh-4rem)] max-w-7xl flex-col justify-center px-6 py-16 md:py-20">
          <div className="max-w-3xl animate-in">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3 animate-in animate-in-delay-4">
              <Link
                to="/order"
                className="group inline-flex items-center gap-2 rounded-full bg-brand px-7 py-4 text-sm font-black uppercase tracking-wider text-brand-foreground shadow-2xl shadow-brand/20 transition-all duration-300 hover:glow hover:scale-[1.02]"
              >
              ...
              <Link
                to="/menu"
                className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-background/50 px-7 py-4 text-sm font-bold uppercase tracking-wider text-foreground backdrop-blur transition-all duration-300 hover:bg-surface hover:border-brand/40"
              >
                Voir le menu
              </Link>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 md:py-20">
          <div className="grid items-center gap-10 md:grid-cols-[1fr_1.4fr]">
            <div className="animate-in">
              ...
              <div className="mt-6 space-y-3">
                {[
                  ...
                  >
                    <div className="grid size-9 place-items-center rounded-xl bg-brand/15 text-brand transition-all duration-300 hover:bg-brand/25">
            ...
            <div className="relative perspective-1000 animate-in animate-in-delay-2">
              <div className="relative overflow-hidden rounded-3xl ring-1 ring-border transition-all duration-500 hover:glow">
                <video
                  src={prepVideo.url}
                  autoPlay
                  muted
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-4">
            {[
              ...
              <div
                ...
                style={{ animationDelay: `${i * 0.1}s` }}
              >
                <div className="rounded-2xl border border-border bg-surface p-6 transition-all duration-300 hover:border-brand/40 hover:glow-sm">
          ...
          <div className="mt-6 flex flex-wrap gap-2 animate-in animate-in-delay-1">
            {GOALS.map((g) => (
              <Link
                key={g.id}
                to="/order"
                className="rounded-full border border-border bg-background px-4 py-2 text-[11px] font-bold uppercase tracking-widest text-muted-foreground transition-all duration-300 hover:border-brand/50 hover:text-brand hover:bg-brand/5"
              >
                {g.label}
              </Link>
            ))}
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
            {MEALS.filter((m) => m.category === "signature").map((m, i) => (
              <div
                ...
                style={{ animationDelay: `${i * 0.1}s` }}
              >
                <div className="flex flex-col overflow-hidden rounded-2xl border border-border bg-background transition-all duration-500 hover:border-brand/40 hover:glow-sm">
                  ...
                  <div className="flex flex-1 flex-col p-5">
                    ...
                    <div className="mt-5 flex items-center justify-between">
                      ...
                      <Link
                        to="/order"
                        className="rounded-full bg-brand px-4 py-2 text-[10px] font-black uppercase tracking-widest text-brand-foreground transition-all duration-300 hover:glow-sm"
                      >
                        Commander
                      </Link>
                    </div>
          ...
          <div className="grid items-center gap-10 md:grid-cols-[1.2fr_1fr]">
            <div className="order-2 md:order-1 animate-in">
              ...
              <div className="mt-6 grid gap-3 sm:grid-cols-2">
                {SHAKES.map((s, i) => (
                  <div
                    key={s.id}
                    className="group flex items-center gap-3 rounded-xl border border-border bg-surface p-3 transition-all duration-300 hover:border-brand/40 hover:glow-sm"
                  >
                    <img
                      ...
                      height={64}
                      loading="lazy"
                      className="size-14 rounded-lg object-cover transition-transform duration-300 group-hover:scale-105"
                    />
              ...
              <Link
                to="/menu"
                className="group mt-6 inline-flex items-center gap-2 rounded-full border border-border bg-surface px-5 py-3 text-xs font-black uppercase tracking-widest transition-all duration-300 hover:bg-surface-2 hover:border-brand/40"
              >
            ...
            <div className="order-1 grid grid-cols-2 gap-3 md:order-2 animate-in animate-in-delay-1">
              <img
                ...
                height={1536}
                loading="lazy"
                className="aspect-[3/4] w-full rounded-2xl object-cover ring-1 ring-border transition-all duration-500 hover:glow-sm"
              />
              <img
                src={shake2}
                ...
                height={1536}
                loading="lazy"
                className="mt-8 aspect-[3/4] w-full rounded-2xl object-cover ring-1 ring-border transition-all duration-500 hover:glow-sm"
              />
            </div>
          </div>
          ...
          <div className="grid items-center gap-10 md:grid-cols-2">
            <div className="animate-in">
              <img
                ...
                height={1024}
                loading="lazy"
                className="aspect-[3/2] w-full rounded-3xl object-cover ring-1 ring-border transition-all duration-500 hover:glow"
              />
            </div>
            <div className="animate-in animate-in-delay-1">
              ...
              <div className="mt-6 grid grid-cols-2 gap-2">
                {SNACKS.slice(0, 6).map((s) => (
                  <div
                    key={s.id}
                    className="rounded-xl border border-border bg-background p-4 transition-all duration-300 hover:border-brand/40 hover:glow-sm"
                  >
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 md:py-20">
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-3">
            {SUBS.map((sub, i) => (
              <div
                key={sub.id}
                className={`relative flex flex-col rounded-2xl border p-6 animate-in animate-in-delay-1 transition-all duration-300 hover:glow-sm ${
              ...
              >
                ...
                <Link
                  to="/subscriptions"
                  className={`mt-6 inline-flex items-center justify-center gap-2 rounded-full px-5 py-3 text-xs font-black uppercase tracking-widest transition-all duration-300 ${
                    sub.popular
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 md:py-20">
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-3">
            {TESTIMONIALS.map((t, i) => (
              <div
                key={t.name}
                className="group relative flex flex-col rounded-2xl border border-border bg-background p-6 animate-in animate-in-delay-1 transition-all duration-500 hover:border-brand/30 hover:glow-sm"
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 md:py-20">
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {GYMS.map((g, i) => (
              <div
                key={g.id}
                className="group rounded-2xl border border-border bg-surface p-5 animate-in animate-in-delay-1 transition-all duration-300 hover:border-brand/40 hover:glow-sm"
                style={{ animationDelay: `${i * 0.1}s` }}
              >
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 text-center md:py-28">
          <div className="animate-in">
            ...
            <Link
              to="/order"
              className="group mt-8 inline-flex items-center gap-2 rounded-full bg-brand px-8 py-4 text-sm font-black uppercase tracking-wider text-brand-foreground transition-all duration-300 hover:glow hover:scale-[1.02]"
            >
...
function StartOrderCTA({
  ...
  return (
    <div className="flex flex-col items-start justify-between gap-4 rounded-2xl border border-brand/30 bg-gradient-to-r from-brand/10 to-brand/5 p-6 md:flex-row md:items-center transition-all duration-300 hover:glow-sm">
      <div>
      ...
      <Link
        to="/order"
        className="group inline-flex items-center gap-2 rounded-full bg-brand px-6 py-3 text-xs font-black uppercase tracking-widest text-brand-foreground transition-all duration-300 hover:glow hover:scale-[1.02]"
      >
        Démarrer ma commande
